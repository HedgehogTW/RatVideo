...
void wxC19DCInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/extract_frame_ratvideo_bitmaps.cpp$D__Project_RatVideo_extract_frame_ratvideo_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/extract_frame_ratvideo_bitmaps.cpp$D__Project_RatVideo_extract_frame_ratvideo_bitmaps.xrc"));
}
